...
class _CreatePdfState extends State<CreatePdfStatefulWidget> {
  ...
  PdfLayoutResult drawHeader(PdfPage page, Size pageSize, PdfGrid grid) {
    ...
    page.graphics.drawString(
        'Reporte de ventas: Agosto/2020', PdfStandardFont(PdfFontFamily.helvetica, 30),
   ...
   /* PdfTextElement(text: invoiceNumber, font: contentFont).draw(
    ...
    return PdfTextElement(text: '', font: contentFont).draw(
        page: page,
        bounds: Rect.fromLTWH(30, /*120*/ 60,
            pageSize.width - (contentSize.width + 30), /*pageSize.height - 120*/ 0));
  }
